...
The other major requirement is `pygraphviz <https://pygraphviz.github.io/>`_. On Ubuntu 16.04 it is also necessary to install package ``graphviz-dev`` by the command ``sudo apt-get install graphviz-dev``.
